...
public class ExcelCreator {
	...
	static FileOutputStream fileCreation; // Will be used for own xl file creation
	...
	public static void main(String[] args) throws IOException {
		...
		XSSFSheet sheetCreate = workbook.createSheet("createdSheet");//creating own sheet--this is for adding data and creating excel.
		...
		fileCreation = new FileOutputStream("OwnCreatedXLfile.xlsx");
		
			try {
				;
				workbook.write(fileCreation);
